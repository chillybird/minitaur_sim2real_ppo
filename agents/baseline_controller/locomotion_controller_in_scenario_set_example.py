...
from minitaur.agents.baseline_controller import locomotion_controller_setup
from minitaur.envs_v2 import env_loader

FLAGS = flags.FLAGS

SCENARIO_SET_CONFIG = """
import minitaur.envs_v2.scenarios.locomotion_simple_scenario_set
